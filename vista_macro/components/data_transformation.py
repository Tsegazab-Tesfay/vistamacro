...
from vista_macro.entity.config_entity import DataTransformationConfig
...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        try:
            ...
            # other steps can be included in here, if for example want to include 
            # log transformation, one can just create an object for that write in
            # side the Pipeline
            ...
            raise VistaMacroException(e, sys) from e
    ...
    def initiate_data_transformation(self,) -> DataTransformationArtifact:
        try:
            ...
            # check the file for valid_train_file_path contain NoneType...
